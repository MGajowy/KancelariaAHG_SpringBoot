...
export class RestApplicationClient {
    ...
    getStr(): RestResponse<string> {
        return this.httpClient.request({ method: "GET", url: uriEncoding`kategorie/pub` });
    }
    ...
    pobierzListeUzytkownikowDto(): RestResponse<UserListDTO> {
        return this.httpClient.request({ method: "GET", url: uriEncoding`uzytkownicy/secured` });
    }
}
